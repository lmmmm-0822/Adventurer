...
namespace EventLogicSystem
{
    ...
    public class BaseFunc
    {
        ...
        public static Dictionary<string, Type> String2EnumType = new Dictionary<string, Type>()
        {
            {typeof(Utils.CompareType).ToString(),typeof(Utils.CompareType) },
            {typeof(EnemyType).ToString(),typeof(EnemyType) },
        };
