...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(EventLogicSystem.StringFunc))
			{
			    return new EventLogicSystem.StringFunc(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(EventLogicSystem.BoolFunc))
			{
			    return new EventLogicSystem.BoolFunc(__Gen_Delegate_Imp12);
			}
